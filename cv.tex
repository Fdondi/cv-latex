...
\MyCvEntry{09/2025 - 11/2025}{Software Engineer (Contract)}{Randstad Digital for Google\\ [YouTube Backend]}{
\begin{compactitemize}
\item Worked on complex legacy data routing systems within YouTube backend
\item Debugged and resolved production issues impacting data flow and system reliability
\item Improved maintainability of legacy systems through refactoring and simplification
\end{compactitemize}
}
