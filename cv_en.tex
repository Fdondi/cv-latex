...
Contributed to cutting-edge research tackling the ARC challenge. Especially focused on data augmentation. Extensively used BART for classification, and Pytorch/Lightning for efficiant multi-GPU training. 
\end{minipage}
}
