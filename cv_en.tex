...
\newcommand{\BeginCourses}{%
	\begin{tabular}{r@{\hspace{1em}}c@{\hspace{1em}}p{0.75\textwidth}}
}
...
%\vspace{-5mm}
\raisebox{\dimexpr\ht\strutbox-\height}{\includegraphics[width=\textwidth]{arduino_btc_project.jpg}}
%\vspace{10mm}
\end{minipage}
...
\textbf{BTC Arduino monitor} \href{https://github.com/Fdondi/arduino-btc}{https://github.com/Fdondi/arduino-btc}
